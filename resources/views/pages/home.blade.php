                ...
                <div class="transform_table">
                  <div class="tranform_table_cell slider11">
                    <div class="main-head-two">
                      <div class="karma_yoga_text world_text">Director's Message</div>                       </div>
              ...
              <div class="transform_content for-home-mobile">
                <div class="transform_table">
                  <div class="tranform_table_cell slider12">
                    <div class="main-head-two">
                      <div class="karma_yoga_text world_text">CAMPUS PLACEMENTS 2021</div>                       </div>
...
.date-new-col span, .date-new-col1 span {
	color: #ff0000;
}
.tab-new1 {
    display: none;
...
.tabcontent-new-box:nth-child(2), .tabcontent-new-box:nth-child(3) {
    padding-left: 20px;
}
}
...
.tab-new button.active, .tab-new button {
    font-size: 22px;
}
.tabcontent-new-col h3 {
	margin-top: -1px;
...
.tabcontent-box-mobile, .tabcontent-new-box h3 {
    width: 32%;
}
.tabcontent-box-mobile1, .tabcontent-new-box p {
    width: 68%;
}
}
...
.tabcontent-new-col p, .tabcontent-box1 a {
    font-size: 14px;
}
.tab-new1 {
    margin-top: -7px;
...
<ul class='submenu'><li><a href='about-us.html'>ABOUT US</a></li><li><a href='about-media.html'>MEDIA</a></li><li><a href='rankings.html'>RANKINGS</a></li><li><a href='accreditations.html'>ACCREDITATIONS</a></li><li><a href='about-us/nirf.html'>NIRF</a></li><li><a href='about-us/campus.html'>CAMPUS</a></li><li><a href='https://www.greatlakes.edu.in/blog/'>BLOG</a></li><li><a href='about-us/events.html'>ANNUAL EVENTS</a></li></ul>
          </li>
      <li>
<div class="link">
            PROGRAMS        <i class="fa fa-angle-down" aria-hidden="true"></i></div>
<ul class='submenu'><li><a href='pgpm.html'>PGPM</a></li><li><a href='pgdm.html'>PGDM</a></li><li><a href='pgxpm.html'>PGXPM</a></li><li><a href='pgpm-flex.html'>PGPM FLEX</a></li><li><a href='corporate-learning-and-development.html'>CORPORATE LEARNING AND DEVELOPMENT</a></li></ul>
          </li>
      <li>
<div class="link">
            FACULTY         <i class="fa fa-angle-down" aria-hidden="true"></i></div>
<ul class='submenu'><li><a href='faculty.html'>FACULTY </a></li><li><a href='faculty/research.html'>RESEARCH</a></li><li><a href='coe.html'>CENTERS OF EXCELLENCE</a></li><li><a href='conferences.html'>CONFERENCES</a></li></ul>
          </li>
      <li>
<div class="link">
            RECRUITERS        <i class="fa fa-angle-down" aria-hidden="true"></i></div>
<ul class='submenu'><li><a href='recruiters/campus-recruitment.html'>CAMPUS RECRUITMENT</a></li><li><a href='recruiters/internships.html'>INTERNSHIPS</a></li><li><a href='recruiters/placement-reports.html'>PLACEMENT REPORTS</a></li><li><a href='recruiters/leadership-series.html'>Leadership Series</a></li></ul>
          </li>
      <li>
<div class="link">
                ...
                <div class="row">
                      ...
                      <div class="col-sm-12 divider event-main">
                    	<div class="row">
                            ...
                            <div class="dates">
                            <p>24<sup>th</sup><span>Jul</span><p>
                            <!--<p>07<sup>th</sup> <span>Oct</span></p>--></div>
                            </div>
                      ...
                      <div class="col-sm-12 divider event-main">
                    	<div class="row">
                        	<div class="col-lg-4 event_left">
                            <div class="dates">
                            <p>07<sup>th</sup><span>Jul</span><p>
                            <!--<p>07<sup>th</sup> <span>Oct</span></p>--></div>
                            </div>
                            <div class="col-lg-8 event_right">
                            <div class="text_right_up events-div-col">
                      ...
                      <div class="col-sm-12 divider event-main">
                    	<div class="row">
                        	<div class="col-lg-4 event_left">
                            <div class="dates">
                            <p>30<sup>th</sup><span>Jun</span><p>
                            <!--<p>07<sup>th</sup> <span>Oct</span></p>--></div>
                            </div>
                            <div class="col-lg-8 event_right">
                            <div class="text_right_up events-div-col">
...
<div class="custom-container-inner"><!-- Nav tabs -->
<div class="card">
...
<!--<div class="admissions-open">Admissions Open for PGDM 2020-22!</div>--><!--<div class="admissions-open">Application Deadline: 10<sup>th</sup> March 2021</div>-->
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 ful-testimonial">
                <div class="testimonials_text_holder">
                	<div class="table_cell_holder_testimonial">
                            <a style="text-decoration: none; margin-top:0;color: #ffffff;" href="#" target="_blank" tabindex="0">   <p class="testimonial-text-col">Dear Father, I’m Prabhu your last year past out student, I hope you and our faculty family doing well father and this mail for  sharing good news father I’m completing my first year (9month) in Kotak with 1 crore of business.</p>
...
<p class="alumni">Prabhu, MBA, Finance</p>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 ful-testimonial">
                <div class="testimonials_text_holder">
                	<div class="table_cell_holder_testimonial">
                            <a style="text-decoration: none; margin-top:0;color: #ffffff;" href="#" target="_blank" tabindex="0">   <p class="testimonial-text-col">I’m here in this position because of JIM. The learnings in JIM were more practical than theoretical and book-oriented. It helped me in various ways in my work-life. Thanks to JIM.</p>
...
<p>Sales Manager, Abbott</p>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 ful-testimonial">
                <div class="testimonials_text_holder">
                	<div class="table_cell_holder_testimonial">
                            <a style="text-decoration: none; margin-top:0;color: #ffffff;" href="#" target="_blank" tabindex="0">   <p class="testimonial-text-col">The two years in JIM molded me into a well-trained professional and gave me ample opportunities that helped me discover myself. I give my heart-out to JIM.</p>
...
<p class="alumni">Mr. Charles Praveen, Key Account Executive, Hindustan Unilever Ltd.,</p>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 ful-testimonial">
                <div class="testimonials_text_holder">
                	<div class="table_cell_holder_testimonial">
                            <a style="text-decoration: none; margin-top:0;color: #ffffff;" href="#" target="_blank" tabindex="0">   <p class="testimonial-text-col">JIM opened up huge opportunities for me; including Internships where we were encouraged to learn about the market. So, thanks to JIM.</p>
